...
func TestValidateContextBrief(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "wrong version", doc: `{"schema_version":1,"status":"ready","summary":"x","acceptance_criteria":["y"]}`},
		{name: "no summary", doc: `{"schema_version":2,"status":"ready","summary":" ","acceptance_criteria":["y"]}`},
		{name: "no acceptance", doc: `{"schema_version":2,"status":"ready","summary":"x","acceptance_criteria":[]}`},
		{name: "unknown field smuggling", doc: `{"schema_version":2,"status":"ready","summary":"x","acceptance_criteria":["y"],"raw_diff":"..."}`},
		{name: "no status", doc: `{"schema_version":2,"summary":"x","acceptance_criteria":["y"]}`},
		{name: "blocked", doc: `{"schema_version":2,"status":"blocked","summary":"x","acceptance_criteria":["y"],"blocked_reason":"memory unavailable"}`},
		{name: "failed precondition", doc: `{"schema_version":2,"status":"ready","summary":"x","acceptance_criteria":["y"],"mandatory_preconditions":[{"id":"routing-e2e-20260824-l1","status":"failed"}]}`},
	}
	...
	oversized := `{"schema_version":2,"status":"ready","summary":"x","acceptance_criteria":["y"],"files":["` +
