...
func (a *e2eAgents) Delegate(_ context.Context, request DelegateRequest) (DelegateResult, error) {
	...
	case "search":
		return DelegateResult{Response: `{"schema_version":1,"status":"ready","summary":"add the feature","files":["feature.txt"],"interfaces":["none"],"constraints":["stay small"],"decisions":["none"],"risks":["low"],"open_questions":[],"acceptance_criteria":["feature exists"],"artifacts":[]}`}, nil
	case "draft":
