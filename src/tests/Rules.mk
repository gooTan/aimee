...
$(TESTPREFIX)/unit-test-provider-cli-adapter: $(OBJDIR)/tests/test_provider_cli_adapter.o \
                      ...
                      $(OBJDIR)/server/cli_acp.o $(OBJDIR)/server/cli_agy.o $(OBJDIR)/posix/workspace_provider.o \
                      $(TEST_CORE_OBJS)
	$(TESTLINK) -o $@ $^ $(TEST_L_FLAGS)
